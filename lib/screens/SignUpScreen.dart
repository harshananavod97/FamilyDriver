                  ...
                  Step(
                    ...
                    content: Form(
                      ...
                      child: Column(
                        children: [
                          SizedBox(height: 8),
                          AppTextField(textFieldType: TextFieldType.PHONE, controller: carProductionController, decoration: inputDecoration(context, label: language.carProductionYear)),
                        ],
                      ),
                    ),
                  ),
                  Step(
                    ...
                    content: Form(
                      ...
                      child: Column(
                        children: [
                          SizedBox(height: 8),
                          AppTextField(textFieldType: TextFieldType.NAME, controller: carPlateController, decoration: inputDecoration(context, label: language.carPlateNumber)),
                        ],
                      ),
                    ),
                  ),
